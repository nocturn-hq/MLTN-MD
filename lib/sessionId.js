...
async function startXeonBotInc() {
    try {
        if (process.env.SESSION_ID) {
            // TEMPORARY DEBUG — remove once SESSION_ID import issue is resolved.
            console.log('🔍 DEBUG SESSION_ID length:', process.env.SESSION_ID.length)
            console.log('🔍 DEBUG SESSION_ID first 20 chars:', process.env.SESSION_ID.slice(0, 20))
            console.log('🔍 DEBUG SESSION_ID last 20 chars:', process.env.SESSION_ID.slice(-20))
