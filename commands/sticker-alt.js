...
async function stickerCommand(sock, chatId, message) {
    try {
        ...
        if (!quotedMsg) {
            await sock.sendMessage(chatId, { text: '⛧ Reply to an image or video to seal it into shadow.' });
            return;
        }
        ...
        await sock.sendMessage(chatId, { text: '☠️ The shadows failed to forge that sticker!' });
    }
}
